...
public class VistaAgregarContacto extends javax.swing.JInternalFrame {
   ...
   private void cargarCiudades(){ //cargamos el comboBox de ciudades
    DefaultComboBoxModel<Ciudad> modelo = new DefaultComboBoxModel<>();
    for (Ciudad c : Gestion.listarCiudades()) {
        modelo.addElement(c);
    }
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        ...
        Ciudad seleccionado = (Ciudad) jComboBoxCiudad.getSelectedItem();
        long telefono = Long.parseLong(jTextFieldTelefono.getText());
        //creamos los objetos de tipo Contacto
        Contacto c1 = new Contacto(dni, apellido, nombre, seleccionado, direccion);
        //Agregarmos al treeMap
        Gestion.agregarContacto(telefono, c1);
